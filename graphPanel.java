...
public class graphPanel extends JPanel {
	...
	//add a new node given the position and label
	public void addNode(int newx, int newy, String label) {
		nodeList.add(new Node(newx, newy, label));
	...
	//get a node giving by the position
	...
	//get the index of a node in nodeList through its label
	...
	//add an edge given the first node and second not and the label
